...
public interface EntityContainer<T> extends Container, Container.Sortable,
	...
	/**
	 * Creates a new {@link EntityItem} for <code>entity</code>. This makes it
	 * possible to use the same {@link com.vaadin.ui.Form} for editing both new
	...
	/**
	 * Creates a new {@link EntityItem} using the method
	 * {@link #createEntityItem(Object))}. The creation of the entity itself is
